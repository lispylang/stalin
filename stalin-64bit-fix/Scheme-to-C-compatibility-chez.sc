...
;;; Fixed for Chez compatibility - (lambda ()) is invalid in standard Scheme
...
(define bit-or bitwise-ior)  ; Chez uses bitwise-ior

(define bitwise-or bitwise-ior)  ; Also define bitwise-or for compatibility
